...
def print_tree(root: Path, file_obj, prefix: str = "") -> None:
    ...
    for index, path in enumerate(entries):
        ...
        # комментарий (ru): пишем сразу в файл, чтобы обойти кодировку консоли Windows
...
if __name__ == "__main__":
    # комментарий (ru): определяем пути
    ...
    # комментарий (ru): открываем файл с явной кодировкой utf-8
